...
{
	public static final List<String> getMinecraftArgs(final Profile profile, final String assetsIndex, final File gameDirectory, final File AssetsDirectory)
	{
		...
		args.add("gameDir " + gameDirectory.getPath());
		args.add("assetsDir " + AssetsDirectory.getPath());
