...
{
	public static final List<String> getMinecraftArgs(final Profile profile)
	{
		...
		args.add("assetIndex " + profile.getAssetsIndex());
		args.add("uuid " + profile.getUUID());
		args.add("accessToken " + "0");//TODO
		args.add("userProperties " + "[]");
		args.add("userType " + "mojang");
		if(ServerConnection.getServerStatus() && profile.isWhiteListed())// if the server is online and player is whitelisted
		{
